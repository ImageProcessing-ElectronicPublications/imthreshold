...
int IMTFilterTGravureLayer (IMTpixel**, WORD**, unsigned, unsigned, int, double, int, int, double);
int IMTFilterTGravure (IMTpixel**, BYTE**, unsigned, unsigned, int, double, int, int, double);
