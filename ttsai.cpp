...
void ImthresholdFilterTTsaiTitle()
{
	printf("ImThreshold.\n");
	printf("BookScanLib Project: http://djvu-soft.narod.ru/\n\n");
	printf("Finds a threshold point using the Tsai Moment Preserving threshold algorithm.\n");
	printf("This algorithm was taken from the gamera.sf.net sourcecodes and adopted for the FreeImage library.\n\n");
}

void ImthresholdFilterTTsaiUsage()
{
	printf("Usage : imthreshold-ttsai [options] <input_file> <output_file>(BW)\n\n");
	printf("options:\n");
...
int main(int argc, char *argv[])
{
	...
	ImthresholdFilterTTsaiTitle();
	
	if(optind + 2 > argc || fhelp)
	{
		ImthresholdFilterTTsaiUsage();
		return 0;
	}
