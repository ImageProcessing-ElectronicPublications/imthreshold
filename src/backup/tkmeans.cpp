...
// K-means thresholding image.
// 
////////////////////////////////////////////////////////////////////////////////

void ImthresholdFilterTKMeansTitle()
{
	printf("ImThreshold.\n");
	printf("BookScanLib Project: http://djvu-soft.narod.ru/\n\n");
	printf("K-means thresholding image.\n");
	printf("TerraNoNames: http://mykaralw.narod.ru/.\n\n");
}

////////////////////////////////////////////////////////////////////////////////

void ImthresholdFilterTKMeansUsage()
{
	printf("Usage : imthreshold-tkmeans [options] <input_file> <output_file>(BW)\n\n");
	printf("options:\n");
...
int main(int argc, char *argv[])
{
	...
	ImthresholdFilterTKMeansTitle();
	
	if(optind + 2 > argc || fhelp || knum < 2)
	{
		ImthresholdFilterTKMeansUsage();
		return 0;
	}
