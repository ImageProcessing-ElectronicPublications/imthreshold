...
// Bimodal thresholding image.

////////////////////////////////////////////////////////////////////////////////

void ImthresholdFilterTBiModTitle()
{
	printf("ImThreshold.\n");
	printf("BookScanLib Project: http://djvu-soft.narod.ru/\n\n");
	printf("Bimodal thresholding image.\n");
	printf("TerraNoNames: http://mykaralw.narod.ru/.\n\n");
}

void ImthresholdFilterTBiModUsage()
{
	printf("Usage : imthreshold-tbimod [options] <input_file> <output_file>(BW)\n\n");
	printf("options:\n");
...
int main(int argc, char *argv[])
{
	...
	ImthresholdFilterTBiModTitle();
	
	if(optind + 2 > argc || fhelp)
	{
		ImthresholdFilterTBiModUsage();
		return 0;
	}
