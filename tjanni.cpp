...
// Janni thresholding image.

////////////////////////////////////////////////////////////////////////////////

void ImthresholdFilterTJanniTitle()
{
	printf("ImThreshold.\n");
	printf("BookScanLib Project: http://djvu-soft.narod.ru/\n\n");
	printf("Janni thresholding image.\n");
	printf("https://habrahabr.ru/post/129898/\n\n");
}

void ImthresholdFilterTJanniUsage()
{
	printf("Usage : imthreshold-tjanni [options] <input_file> <output_file>(BW)\n\n");
	printf("options:\n");
	printf("          -h      this help\n");
}
...
int main(int argc, char *argv[])
{
	...
	ImthresholdFilterTJanniTitle();
	
	if(optind + 2 > argc || fhelp > 0)
	{
		ImthresholdFilterTJanniUsage();
		return 0;
	}
