...
void ImthresholdFilterDespeck2Title()
{
	printf("ImThreshold.\n");
	printf("BookScanLib Project: http://djvu-soft.narod.ru/\n\n");
	printf("Simple despeckle mean filter (for BW only) based on the FreeImage library.\n");
	printf("This code is taken from the CxImage Library at http://www.xdp.it/cximage.htm\n\n");
}

void ImthresholdFilterDespeck2Usage()
{
	printf("Usage : imthreshold-fdespeckle [options] <input_file>(BW) <output_file>(BW)\n\n");
	printf("options:\n");
...
int main(int argc, char *argv[])
{
	...
	ImthresholdFilterDespeck2Title();
	
	if(optind + 2 > argc || fhelp || Ksize < 1)
	{
		ImthresholdFilterDespeck2Usage();;
		return 0;
	}
