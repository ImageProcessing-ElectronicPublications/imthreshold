...
// Histogram rotation balance thresholding image.

////////////////////////////////////////////////////////////////////////////////

void ImthresholdFilterTRotTitle()
{
	printf("ImThreshold.\n");
	printf("BookScanLib Project: http://djvu-soft.narod.ru/\n\n");
	printf("Histogram rotation balance thresholding image.\n");
	printf("Debian-noofficial: https://sourceforge.net/projects/debiannoofficial/\n\n");
}

////////////////////////////////////////////////////////////////////////////////

void ImthresholdFilterTRotUsage()
{
	printf("Usage : imthreshold-trot [options] <input_file> <output_file>(BW)\n\n");
	printf("options:\n");
...
int main(int argc, char *argv[])
{
	...
	ImthresholdFilterTRotTitle();
	
	if(optind + 2 > argc || fhelp)
	{
		ImthresholdFilterTRotUsage();
		return 0;
	}
